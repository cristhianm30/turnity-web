  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="text-center">
        <div className="mb-6">
          <div className="mx-auto h-16 w-16 rounded-2xl glass bg-sun-100/80 dark:bg-sun-500/20 flex items-center justify-center">
            <Inbox className="h-8 w-8 text-sun-500 dark:text-sun-400" />
          </div>
        </div>
